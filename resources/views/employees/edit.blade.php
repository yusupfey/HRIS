                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="employeeForm" action="{{ route('employees.update', $employee->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <input id="uuid" class="block mt-1 w-full" type="text" name="uuid" value="{{ $employee->uuid }}" required autofocus>
                        </div>
                        <div class="mt-4">
                            <label for="name">Name</label>
                            <input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ $employee->name }}" required>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="tempat_lahir" class="block mt-1 w-full" type="text" name="tempat_lahir" value="{{ $employee->tempat_lahir }}" required>
                        </div>
                        <div class="mt-4">
                            <label for="alamat">Alamat</label>
                            <textarea id="alamat" name="alamat" class="block mt-1 w-full" required>{{ $employee->alamat }}</textarea>
                        </div>
                        <div class="mt-4">
