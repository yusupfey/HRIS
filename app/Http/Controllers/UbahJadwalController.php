...
public function store(Request $request)
{
    ...
    return redirect()->to('/ubahjadwal/store')->with('success', 'Tukar shift berhasil diajukan.');
}
...
public function  getform($id)
{
    ...
    // dd($reference);
    $employee = Employee::where('uuid', '=', Session::get('uuid'))->first();//ambil data karyawan login
    ...
    ->whereYear('tanggal', $tahun)
    ->get();            
    return view('ubahjadwal.updateform',compact('ubahjadwal','employee','karyawan_pengganti','shift','workschedules','shifts','reference'));
}
